	...
	<div class="container-md py-4">
		...
		<div>
			<ul class="list-group mt-4 w-75 mx-auto">
				...
				<a class="btn btn-secondary" href="email_change.jsp" role="button">Email変更</a></li>

				<li class="list-group-item d-flex justify-content-center">
				<a class="btn btn-secondary" href="password_change.jsp" role="button">Password変更</a></li>
